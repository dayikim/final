<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  ...
  <!-- Nav Bar Start -->
        ...
        <!-- Nav Bar End -->
			<section id="write">
				<div class="container">
					<form action="/tBoard/sellingModify" method="post" id="writeform" enctype="multipart/form-data">
						<div class="form-control wrapper ">
							...
							<div class="input-group mb-3 col-md-12 ">
								<label class="input-group-text input"
									for="inputGroupSelect02">재능명<strong>＊</strong></label>
							...
							<div class="input-group mb-3 col-md-12">
								...
								<div class="input-group mb-3 col-md-12 " id="preview">
									<c:forEach var="f" items="${flist}">
										<li file="${f.oriName}">
											<img class = "img-thumb" src="/imgs/selling/${f.sysName}">
