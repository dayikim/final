        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto">
                    <input class="form-control mr-sm-5" type="search" placeholder="물품, 지역을 검색해주세요." id=search
                        aria-label="Search">
        ...
        <div class="container">
            <div class="form-control wrapper ">
                ...
                <section id="user-profile">
                    <h2 id="nickname">
                        ${profile.user} <span id="region_name">송파구 잠실2동</span>
                    </h2>
                    ...
                    <!-- <c:choose>
                            <c:when test="${profile_img != null}">
                                <img src=" ${pageContext.request.contextPath}/profile/${view.writer}/${profile_img}"
                                    class="card-img-top" alt="profile_picture" id=profile>
                            </c:when> -->
                    <!-- <c:otherwise>
                    ...
                    <div class="tab_basic">
                        <div class="tab_list_wrap">
                            <div class="tab_list tab_active" data-tabnum="0">
                                <a href="/TBoard/sellingList">판매목록()</a>
                            </div>
                            <div class="tab_list" data-tabnum="1">
                                <a href="/TBoard/Review">거래 후기()</a>
                            </div>
                                            ...
                                            <div class="comment_writerInfo">
                                                <section id="small_user-profile">
                                                    ...
                                                    <!-- <c:choose>
                                                        <c:when test="${profile_img != null}">
                                                            <img src=" ${pageContext.request.contextPath}/profile/${view.writer}/${profile_img}"
                                                                class="card-img-top" alt="profile_picture" id=small_profile>
                                                        </c:when> -->
                                                    <!-- <c:otherwise>
                                                            <img src="${defalut_profile_img}" class="card-img-top" alt="profile_picture" id=small_profile>
                                                        </c:otherwise>
                                                    </c:choose> -->
                                                    <!-- </div> -->
                                                </section>
