	...
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
							...
							if (check) {
								$.ajax({
									...
									if (resp == 0) {
										$.ajax({
											url: "/profile/review",
											data: { recipient: recipient, parentseq: parentseq, reviewer:reviewer, reviewable: reviewable, contents: contents, boardtype: boardtype }
										}).done(function (resp) {
											console.log(resp);
											if (resp == 1) {
		...
		<body>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="top-bar-right">
								<div class="social">
									<a href="/sns/main"><i class="fab fa-twitter"></i></a> <a href="/sns/main"><i
											class="fab fa-facebook-f"></i></a> <a href="/sns/main"><i
			...
			<div class="navi">
				<div class="navi1">
					<ul class="navbar-nav">
						<li class="nav-item dropdown"><a class="nav-link dropdown-toggle1" href="#"
								id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true"
								aria-expanded="false"> <b>물품 ▼</b>
							</a>
							<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
				...
				<div class=navi2>
					<ul class="navbar-nav">
						<li class="nav-item dropdown"><a class="nav-link dropdown-toggle2" href="#"
								id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true"
								aria-expanded="false"> <b>재능 ▼</b>
							</a>
							<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
			...
			<div class="container2">
				...
				<!-- 판매 완료 출력 -->
				<c:forEach var="i" items="${talentbuyList}">
					<div class="completDiv">
						...
						<div class="row complet">
							...
							<div class="col-12 col-md-8 col-sm-8 information">
								<div>
									<h4>
										<a href="/tBoard/sellingView?id=${i.buyer}&seq=${i.seq}"><b>${i.item}</b></a>
									</h4>
								</div>
								<div>${i.name}ㅣ${i.address1}</div>
						...
						<div class="review">
							...
							<a href="" data-toggle="modal" data-target="#exampleModal2" id="other">작성한 후기 보기</a>
							</c:when>
							<c:otherwise>
							<a href="" data-toggle="modal" data-target="#exampleModal1" id="other">거래 후기 보내기</a>
							</c:otherwise>
							</c:choose>
							
							<div class="modal fade modal_box" id="exampleModal1" tabindex="-1"
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											<div class="form-group">
												<div class="mb-3 review_form">
													<label class="col-form-label review_title">거래 경험이
														좋으셨나요?</label> <label
														class="col-form-label review_text">${i.name}님에게
											...
											<input type="hidden" name="reviewer" value="${loginID}" id="reviewer">
											<input type="hidden" name="recipient" value="${i.seller}" id="recipient">
											<input type="hidden" name="boardtype" value="${i.boardtype}" id="boardtype">
											<input type="hidden" name="seq" value="${i.parentseq}" id="parentseq">
									...
									<div class="modal fade modal_box" id="exampleModal2" tabindex="-1"
								aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title" id="exampleModalLabel">내가 보낸 거래후기 보기</h5>
											...
											<div class="form-group">
												<div class="mb-3 review_form">
													<label class="col-form-label review_title">${i.name}님에게
														감사인사를 남겼습니다.</label> <label
														class="col-form-label review_text"></label> <img src="/imgs/letter.png">
