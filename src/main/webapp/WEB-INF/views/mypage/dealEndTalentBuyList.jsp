...
<body>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="top-bar-right">
						<div class="social">
							<a href="/sns/main"> <i class="fab fa-twitter"></i>
							</a> <a href="/sns/main"> <i class="fab fa-facebook-f"></i>
							</a> <a href="/sns/main"> <i class="fab fa-instagram"></i>
							</a>
						</div>
					</div>
				</div>
	...
	<div class="container2">
		...
		<!---------forEach 사용 구간------------------------------------------------------------------------------>
		<!-- 구매 완료 출력 -->
		<c:forEach var="i" items="${talentbuyList}" varStatus="vs">
			<div class="completDiv">
				<div class="row complet">
					...
					<div class="col-12 col-md-8 col-sm-8 information">
						...
						<div>재능 판매자: ${i.name}ㅣ${i.address1}</div>
