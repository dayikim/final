				...
				<c:forEach var="i" items="${productBuyList}" varStatus="vs">
					<div class="completDiv">
						<div class="row complet">
							...
							<div class="col-12 col-md-8 col-sm-8 information">
								<div>
									<h4>
										<!-- lendboard 링크 수정!!!! -->
										<a href="/lendBoard/lendView?id=${i.seller}&seq=${i.parentseq}">
											<b>${i.item}</b>
										</a>
									</h4>
								</div>
						...
						<div class="review">
							...
							<div class="modal fade modal_box" id="myModal${vs.index}" tabindex="-1"
											...
											<div class="form-group">
												<div class="mb-3 review_form">
													<label class="col-form-label review_title">거래 경험이
														좋으셨나요?</label> <label
														class="col-form-label review_text">${i.seller}님에게
											...
											<div class="form-group">
												<div class="mb-3 review_form">
													<label class="col-form-label review_title">${i.name}님에게
														...
														class="col-form-label review_text"></label>
