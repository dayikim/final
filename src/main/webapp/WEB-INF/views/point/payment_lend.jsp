					...
					<div class="form-control wrapper">
						...
						<div class="btn_wrap">
							<form action="/point/payment" id="payForm">
								...
								<input type="hidden" name="item" value="${board.title}"> <input type="hidden"
									name="price" value="${board.price}" id="price">
								<input type="hidden" name="parentseq" value="${board.seq}" id="parentseq"> <input
									type="hidden" name="category" value="${board.category}" id="category"> <input
