					...
					<div class="form-control wrapper ">
						...
						<section id="card_payment">
																...
																<div class="modal-body">
																	<div class="form-group">
																		...
																		<input type="number" class="form-control"
																			id="amount_input" placeholder="충전금액"
																			required></input><span
								...
								<section id="paymentMethod">
									...
									<div class="form-check card">
										<input class="form-check-input" type="radio" name="paymentmethod"
											value="creditcard" id="card" checked> <label class="form-check-label"
											for="flexRadioDefault2" id="card">
											신용카드 </label>
									</div>
								</section>
								<section id="payment">
									<div class="point_wrap">
										...
										<div class="pay_box">
											<span>
												<h5 id="pay_amount"><b>충전금 결제액: </b> <input class="amount" readonly> <b
														id="won">원</b></h5>
											</span>
							...
							<div class=" btn_wrap text-right ">
								<button type="button" onclick="history.back()" class="btn btn-info btn-lg">마이페이지로
									이동</button>
							</div>
						</section>
